...
import { Bot, User, Send, Sparkles, Code, FileText, Lightbulb } from 'lucide-react';
...
export const GeminiChat: React.FC<GeminiChatProps> = ({ repositoryData }) => {
  ...
  return (
    <div className="fixed inset-4 z-50 flex items-center justify-center">
      <div 
        ref={chatRef}
        className="w-full max-w-4xl h-full max-h-[80vh] glass-card-intense rounded-3xl overflow-hidden shadow-2xl"
      >
